...
QuintRooms uses a querystring username and password to allow access to the API. You can request QuintRooms API credentials by partnering with us and emailing [support](mailto:hello@quintrooms).
...
1. [Request a Site Admin](mailto:hello@quintrooms?Subject=Request%20for%20Site%20Admin%20User) to be added to your closed user group site (if you don't already have one)
...
Please [contact us](mailto:hello@quintrooms?Subject=Request%20for%20API%20Gateway%20Codes) for an updated list of gateways.
...
You will need a Site Admin user in your closed user group site. If you don't already have one, please [request one](mailto:hello@quintrooms?Subject=Request%20for%20Site%20Admin%20User) be added for your portal/site.
