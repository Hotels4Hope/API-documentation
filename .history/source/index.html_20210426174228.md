...
QuintRooms uses a querystring username and password to allow access to the API. You can request QuintRooms API credentials by partnering with us and emailing [support](mailto:hello@hotelsforhope.com).
